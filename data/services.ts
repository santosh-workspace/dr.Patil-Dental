...
export interface Service {
  ...
  name: string;
  icon: LucideIcon;
  /** Card/hero photo — featured services carry one; others render the icon card. */
  image?: string;
  imageAlt?: string;
...
export const services: Service[] = [
  {
    ...
    icon: Anchor,
    image: "/images/implant-model-closeup.jpg",
    imageAlt:
      "Cross-section dental model showing a titanium implant screw beside natural tooth roots",
    shortDescription:
  ...
  },
  {
    ...
    icon: Syringe,
    image: "/images/root-canal-imaging.jpg",
    imageAlt:
      "Dentist studying 3D imaging films of tooth roots on a light box",
    shortDescription:
  ...
  },
  {
    ...
    name: "Crowns & Bridges",
    icon: Crown,
    image: "/images/crown-shade-matching.jpg",
    imageAlt:
      "Bright dental treatment unit with a tooth shade guide for matching crowns",
    shortDescription:
  ...
  },
  {
    ...
    icon: Sparkles,
    image: "/images/teeth-whitening-smile.jpg",
    imageAlt: "Close-up of a bright, confident smile with white teeth",
    shortDescription:
  ...
  },
  {
    ...
    icon: Braces,
    image: "/images/braces-adjustment-light.jpg",
    imageAlt:
      "Orthodontic braces brackets being fixed with a curing light",
    shortDescription:
  ...
  },
  {
    ...
    icon: Baby,
    image: "/images/gentle-dental-checkup.jpg",
    imageAlt:
      "Smiling young patient holding a mirror during a gentle dental check-up",
    shortDescription:
  ...
  },
  {
    ...
    icon: Stethoscope,
    image: "/images/dental-examination-mirror.jpg",
    imageAlt:
      "Close-up of a dental examination with a mouth mirror and probe",
    shortDescription:
  ...
  },
  {
    ...
    icon: Wrench,
    image: "/images/extraction-instruments.jpg",
    imageAlt:
      "Sterile extraction forceps and surgical instruments laid out on a clean field",
    shortDescription:
  ...
  },
  {
    ...
    icon: Moon,
    image: "/images/surgical-procedure-prep.jpg",
    imageAlt:
      "Dentist positioning the operating light before a surgical procedure",
    shortDescription:
  ...
  },
  {
    ...
    name: "Dentures",
    icon: Layers,
    image: "/images/denture-model-consult.jpg",
    imageAlt:
      "Dentist holding a full upper and lower denture model during a consultation",
    shortDescription:
  ...
  },
  {
    ...
    icon: Smile,
    image: "/images/smile-design-result.jpg",
    imageAlt: "Warm natural smile showing bright, even teeth",
    shortDescription:
  ...
  },
  {
    ...
    name: "Dental Veneers",
    icon: ScanLine,
    image: "/images/veneer-shade-selection.jpg",
    imageAlt:
      "Dentist matching a tooth shade guide to a smiling patient's teeth",
    shortDescription:
  ...
  },
  {
    ...
    icon: HeartPulse,
    image: "/images/gum-therapy-treatment.jpg",
    imageAlt:
      "Dentist performing a gentle gum cleaning procedure on a relaxed patient",
    shortDescription:
  ...
  },
  {
    ...
    icon: Droplets,
    image: "/images/filling-procedure.jpg",
    imageAlt:
      "Close-up of a dental filling being polished with a fine handpiece",
    shortDescription:
  ...
  },
  {
    ...
    icon: Shield,
    image: "/images/preventive-visit-smile.jpg",
    imageAlt:
      "Young patient smiling with a dentist during a relaxed preventive visit",
    shortDescription:
  ...
  },
  {
    ...
    icon: Microscope,
    image: "/images/full-mouth-planning-model.jpg",
    imageAlt:
      "Full-mouth dental model with articulator and restoration tools on a planning tray",
    shortDescription:
  ...
  },
  {
    ...
    icon: Siren,
    image: "/images/urgent-dental-care.jpg",
    imageAlt:
      "Patient being made comfortable in the dental chair for prompt treatment",
    shortDescription:
  ...
  },
  {
    ...
    icon: CircleDot,
    image: "/images/digital-scan-tablet.jpg",
    imageAlt:
      "Gloved hands reviewing 3D dental scans on a tablet screen",
    shortDescription:
